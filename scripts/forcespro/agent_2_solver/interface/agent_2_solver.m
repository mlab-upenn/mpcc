% agent_2_solver - a fast solver generated by FORCES PRO v3.1.0
%
%   OUTPUT = agent_2_solver(PARAMS) solves a multistage problem
...
%
%   [OUTPUT, EXITFLAG] = agent_2_solver(PARAMS) returns additionally
...
%    -100 - License error
%
%   [OUTPUT, EXITFLAG, INFO] = agent_2_solver(PARAMS) returns 
