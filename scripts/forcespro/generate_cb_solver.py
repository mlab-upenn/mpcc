...
def get_cb_solver( solverparams = "solverparams.yaml", modelparams = "modelparams.yaml", name = "cb_solver", generatesolver = 1):
    if generatesolver == 0:
    ...
    pvars = ['xt', 'yt', 'phit', 'sin_phit', 'cos_phit', 'theta_hat', 'Qc', 'Ql', 'Q_theta', 'R_d', 'R_delta', \
             'r', 'x_ob', 'y_ob', 'phi_ob', 'alpha_0', 'alpha_1', 'a_01', 'a_02', 'a_11', 'a_12', 'mu_t_x', 'mu_t_y']
