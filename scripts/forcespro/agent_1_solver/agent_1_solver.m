% agent_1_solver - a fast solver generated by FORCES PRO v3.1.0
%
%   OUTPUT = agent_1_solver(PARAMS) solves a multistage problem
%   subject to the parameters supplied in the following struct:
%       PARAMS.x0 - column vector of length 420
%       PARAMS.xinit - column vector of length 9
%       PARAMS.all_parameters - column vector of length 630
%
...
%
%   [OUTPUT, EXITFLAG] = agent_1_solver(PARAMS) returns additionally
...
%    -100 - License error
%
%   [OUTPUT, EXITFLAG, INFO] = agent_1_solver(PARAMS) returns 
