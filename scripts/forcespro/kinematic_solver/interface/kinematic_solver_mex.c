...
extern void (kinematic_solver_float *x, kinematic_solver_float *y, kinematic_solver_float *l, kinematic_solver_float *p, kinematic_solver_float *f, kinematic_solver_float *nabla_f, kinematic_solver_float *c, kinematic_solver_float *nabla_c, kinematic_solver_float *h, kinematic_solver_float *nabla_h, kinematic_solver_float *hess, solver_int32_default stage, solver_int32_default iteration);
kinematic_solver_extfunc pt2function_kinematic_solver = &;


/* Some memory for mex-function */
static kinematic_solver_params params;
static kinematic_solver_output output;
static kinematic_solver_info info;
...
void mexFunction( solver_int32_default nlhs, mxArray *plhs[], solver_int32_default nrhs, const mxArray *prhs[] )  
{
    ...
    if (nrhs != 1) 
	{
        mexErrMsgTxt("This function requires exactly 1 input: PARAMS struct.\nType 'help kinematic_solver_mex' for details.");
    }    
	if (nlhs > 3) 
	{
	...
	{
    mexErrMsgTxt("PARAMS.all_parameters must be of size [240 x 1]");
    }
#endif	 
	if ( (mxGetN(par) != 0) && (mxGetM(par) != 0) )
	{
		copyMArrayToC_double(mxGetPr(par), params.all_parameters,240);

	}


	#if SET_PRINTLEVEL_kinematic_solver > 0
	...
	/* call solver */
	exitflag = kinematic_solver_solve(&params, &output, &info, fp, pt2function_kinematic_solver);
