...
extern void (FORCES_NLP_solver_float *x, FORCES_NLP_solver_float *y, FORCES_NLP_solver_float *l, FORCES_NLP_solver_float *p, FORCES_NLP_solver_float *f, FORCES_NLP_solver_float *nabla_f, FORCES_NLP_solver_float *c, FORCES_NLP_solver_float *nabla_c, FORCES_NLP_solver_float *h, FORCES_NLP_solver_float *nabla_h, FORCES_NLP_solver_float *hess, solver_int32_default stage, solver_int32_default iteration);
...
void mexFunction( solver_int32_default nlhs, mxArray *plhs[], solver_int32_default nrhs, const mxArray *prhs[] )  
{
	...
	/* call solver */
	exitflag = FORCES_NLP_solver_solve(&params, &output, &info, fp, pt2function_FORCES_NLP_solver);
