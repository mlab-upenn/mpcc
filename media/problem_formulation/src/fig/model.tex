...
\draw[->] (-7.1528,-2.9609) -- (-7.1528,-1.4609);
\node at (-7.3789,-1.4052) {$y$};
\draw[->] (-7.1528,-2.9609) -- (-5.6528,-2.9609);
\node at (-5.5384,-3.1586) {$x$};
...
\node[inner sep=0pt, rotate = 25, opacity = 0.04] (car) at (-2.2,0.95){\includegraphics[width=.5\textwidth]{fig/race_car.png}};
\end{tikzpicture}