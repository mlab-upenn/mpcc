% kinematic_solver - a fast solver generated by FORCES PRO v3.1.0
%
%   OUTPUT = kinematic_solver(PARAMS) solves a multistage problem
...
%
%   [OUTPUT, EXITFLAG] = kinematic_solver(PARAMS) returns additionally
...
%    -100 - License error
%
%   [OUTPUT, EXITFLAG, INFO] = kinematic_solver(PARAMS) returns 
